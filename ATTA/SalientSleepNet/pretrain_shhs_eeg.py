...
from preprocess_shhs import get_double_eeg_datasets
...
def parse_arguments() -> Tuple[str, int, int, int, int, str, str]:
    ...
    parser.add_argument("--pth_dir", "-p", type=str, default=r'pretrained_model/model_shhs_eeg.pth')
...
if __name__ == '__main__':
    ...
    for dataset in double_eeg_dataset_list:
        dataset.normalization()
    
    eeg_dataset_list_total = data_split(double_eeg_dataset_list, 0, round(file_num*0.8))
    eeg_dataset_list_total_val=data_split(double_eeg_dataset_list, round(file_num*0.8), file_num)
    ...
    for k in range(folds):
        print(f"\n=======================================\
            ...
            ===============================================")
        # train set
        train_set = reduce(lambda x, y: x + y, eeg_dataset_list_total)
        # validation set
        val_set = reduce(lambda x, y: x + y, eeg_dataset_list_total_val)
