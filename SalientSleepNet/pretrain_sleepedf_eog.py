...
from preprocess_sleepedf import get_double_eog_datasets
...
def parse_arguments() -> Tuple[str, int, int, int, int, str, str]:
    ...
    parser.add_argument("--pth_dir", "-p", type=str, default=r'pretrained_model/model_sleepedf_eog.pth')
...
if __name__ == '__main__':
    ...
    # dataset
    dataset_list = get_double_eog_datasets(data_path1,stride=window_size)
